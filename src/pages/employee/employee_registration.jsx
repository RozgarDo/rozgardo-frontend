                ...
                <div className="grid sm:grid-cols-2 gap-6">
                  <div className="space-y-1.5">
                    ...
                    <div className="relative group">
                      ...
                      <input type="text" name="fullName" value={formData.fullName} onChange={handleInputChange} className="w-full pl-11 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all outline-none" placeholder="Ramesh Kumar" />
                    </div>
                  </div>
                  <div className="space-y-1.5">
                    ...
                    <div className="relative group">
                      ...
                      <input type="tel" name="phoneNumber" value={formData.phoneNumber} onChange={handleInputChange} className="w-full pl-11 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all outline-none" placeholder="9876543210" />
                    </div>
                  </div>
                </div>
                ...
                <div className="grid sm:grid-cols-2 gap-6">
                  <div className="space-y-1.5">
                    ...
                    <div className="relative group">
                      ...
                      <input type="text" name="currentLocation" value={formData.currentLocation} onChange={handleInputChange} className="w-full pl-11 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all outline-none" placeholder="City, Area" />
                    </div>
                  </div>
                  <div className="space-y-1.5">
                    ...
                    <div className="relative group">
                      ...
                      <select name="highestQualification" value={formData.highestQualification} onChange={handleInputChange} className="w-full pl-11 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all outline-none appearance-none">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {jobTypesList.map(job => (
                      <button type="button" key={job} onClick={() => handleToggleItem('jobTypes', job)}
                    ...
                    {!showCustomJobInput ? (
                      ...
                      <div className="flex items-center gap-2">
                        <input autoFocus type="text" value={customJobInput} onChange={(e) => setCustomJobInput(e.target.value)} onKeyDown={(e) => e.key === 'Enter' && handleAddCustom('jobTypes', customJobInput, setCustomJobInput, setShowCustomJobInput)} className="px-3 py-1.5 text-sm border-2 border-indigo-500 rounded-lg outline-none" placeholder="Enter role..." />
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {languagesList.map(lang => (
                      <button type="button" key={lang} onClick={() => handleToggleItem('preferredLanguages', lang)}
                    ...
                    {!showCustomLangInput ? (
                      ...
                      <div className="flex items-center gap-2">
                        <input autoFocus type="text" value={customLangInput} onChange={(e) => setCustomLangInput(e.target.value)} onKeyDown={(e) => e.key === 'Enter' && handleAddCustom('preferredLanguages', customLangInput, setCustomLangInput, setShowCustomLangInput)} className="px-3 py-1.5 text-sm border-2 border-indigo-500 rounded-lg outline-none" placeholder="Enter language..." />
                ...
                <div className="grid sm:grid-cols-2 gap-6 pt-4 border-t border-slate-100">
                  <div className="space-y-1.5">
                    ...
                    <div className="relative group">
                      ...
                      <input type={showPassword ? 'text' : 'password'} name="password" onChange={handleInputChange} className="w-full pl-11 pr-11 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 outline-none" />
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative group">
                      <Lock className="absolute left-3.5 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-indigo-500 transition-colors" size={18} />
                      <input type={showConfirmPassword ? 'text' : 'password'} name="confirmPassword" onChange={handleInputChange} className="w-full pl-11 pr-11 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 outline-none" />
                    </div>
                  </div>
                </div>

                <button type="submit" disabled={loading} className="w-full bg-indigo-600 text-white py-4 rounded-2xl font-bold text-lg hover:bg-indigo-700 hover:shadow-xl hover:shadow-indigo-200 transition-all disabled:opacity-70 flex items-center justify-center gap-3 mt-4">
